        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dimensionality = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameCatagories", x => new { x.GameId, x.CatagoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Libraries_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameCatagories_CatagoryId",
                table: "GameCatagories",
                column: "CatagoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Libraries_OrderId",
                table: "Libraries",
                column: "OrderId",
                unique: true);
